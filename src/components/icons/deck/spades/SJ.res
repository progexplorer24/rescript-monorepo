...
let make = (~backgroundFill=CardDefaults.backgroundFill, ~cardBorder=CardDefaults.cardBorder) =>
  <svg
    ...
    <path
      d="M101.164 68.125H112.883V107.5C112.883 111.12 112.076 114.323 110.461 117.109C108.872 119.87 106.62 122.005 103.703 123.516C100.786 125.026 97.4922 125.781 93.8203 125.781C87.8047 125.781 83.1172 124.258 79.7578 121.211C76.3984 118.138 74.7188 113.802 74.7188 108.203H86.5156C86.5156 110.99 87.1016 113.047 88.2734 114.375C89.4453 115.703 91.2943 116.367 93.8203 116.367C96.0599 116.367 97.8438 115.599 99.1719 114.062C100.5 112.526 101.164 110.339 101.164 107.5V68.125Z"
      fill="black"
    />
    <path
      fillRule="evenodd"
