...
module JQuery = {
  @send
  external get: (array<jQueryElement>, unit) => array<Webapi.Dom.Element.t> = "get"
  @send external getWithIndex: (array<jQueryElement>, int) => Webapi.Dom.Element.t = "get"
}
...
@send external shouldWithCallback: ('element, array<jQueryElement> => unit) => unit = "should"
@send external shouldWithCallbackP: ('element, array<jQueryElement> => unit) => 'element = "should"
