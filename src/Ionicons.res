module Styles = {
  ...
  let svgString = "<svg xmlns='http://www.w3.org/2000/svg' class='ionicon' viewBox='0 0 512 512'><title>Clipboard</title><path d='M368 48h-11.41a8 8 0 01-7.44-5.08A42.18 42.18 0 00309.87 16H202.13a42.18 42.18 0 00-39.28 26.92 8 8 0 01-7.44 5.08H144a64 64 0 00-64 64v320a64 64 0 0064 64h224a64 64 0 0064-64V112a64 64 0 00-64-64zm-48.13 64H192.13a16 16 0 010-32h127.74a16 16 0 010 32z'/></svg>"
...
let default = () => {
  <div className=Styles.wrapper>
    ...
    <div
      ...
      <div className={Tailwind.merge(. [Styles.block])}>
        <Ion.Filled.chevronBackCircle />
        <h2 className={Tailwind.merge(. [Styles.h2])}> {"chevronBackCircle"->Utils.str} </h2>
      </div>
      <div className={Tailwind.merge(. [Styles.block])}>
        <Ion.Filled.chevronDown />
        <h2 className={Tailwind.merge(. [Styles.h2])}> {"chevronDown"->Utils.str} </h2>
      </div>
      <div className={Tailwind.merge(. [Styles.block])}>
        <Ion.Filled.chevronDownCircle />
        <h2 className={Tailwind.merge(. [Styles.h2])}> {"chevronDownCircle"->Utils.str} </h2>
      </div>
      <div className={Tailwind.merge(. [Styles.block])}>
        <Ion.Filled.chevronForward />
        <h2 className={Tailwind.merge(. [Styles.h2])}> {"chevronForward"->Utils.str} </h2>
      </div>
      <div className={Tailwind.merge(. [Styles.block])}>
        <Ion.Filled.chevronForwardCircle />
        <h2 className={Tailwind.merge(. [Styles.h2])}> {"chevronForwardCircle"->Utils.str} </h2>
      </div>
      <div className={Tailwind.merge(. [Styles.block])}>
        <Ion.Filled.chevronUp />
        <h2 className={Tailwind.merge(. [Styles.h2])}> {"chevronUp"->Utils.str} </h2>
      </div>
      <div className={Tailwind.merge(. [Styles.block])}>
        <Ion.Filled.chevronUpCircle />
        <h2 className={Tailwind.merge(. [Styles.h2])}> {"chevronUpCircle"->Utils.str} </h2>
      </div>
      <div className={Tailwind.merge(. [Styles.block])}>
        <Ion.Filled.clipboard />
        <h2 className={Tailwind.merge(. [Styles.h2])}> {"clipboard"->Utils.str} </h2>
      </div>
      // <div className={Tailwind.merge(.[Styles.block])}>
      //   <Ion.Filled.caretForwardCircle />
