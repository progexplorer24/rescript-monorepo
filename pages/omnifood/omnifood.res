...
module Styles = {
  ...
  let smallGlobal = style(.[
    media("only screen and (max-width: 767px)", [overflowX(#hidden), fontSize(#px(15))]),
  ])

  let mediumBreakpointGlobal = style(.[
    media("only screen and (max-width: 1023px)", [fontSize(#px(18))]),
  ])
  ...
  let smallRow = style(.[
    media("only screen and (max-width: 767px)", [padding2(~v=#px(0), ~h=#percent(4.))]),
  ])

  let largeBreakpointRow = style(.[
    media("only screen and (max-width: 1200px)", [padding2(~v=#px(0), ~h=#percent(2.))]),
  ])
  ...
  let smallH1 = style(.[media("only screen and (max-width: 767px)", [fontSize(#percent(180.))])])
  ...
  // let smallMainNav = style(.[media("only screen and (max-width: 767px)", [display(#none)])])
  ...
  let h2Small = style(.[media("only screen and (max-width: 767px)", [fontSize(#percent(150.))])])
  ...
  let smallP = style(.[
    media("only screen and (max-width: 767px)", [width(#percent(100.)), marginLeft(#px(0))]),
  ])

  let mediumP = style(.[
    media("only screen and (max-width: 1023px)", [width(#percent(80.)), marginLeft(#percent(10.))]),
  ])
  ...
  let smallStepsBox = style(.[media("only screen and (max-width: 767px)", [marginTop(#px(10))])])

  let mediumStepsBox = style(.[media("only screen and (max-width: 1023px)", [marginTop(#px(10))])])

  let stepsBox = CssJs.merge(.[style(.[marginTop(#px(30))]), mediumStepsBox, smallStepsBox])

  let smallLeftSection = style(.[
    media("only screen and (max-width: 767px)", [textAlign(#center), paddingRight(#px(0))]),
  ])
  ...
  let smallAppScreen = style(.[media("only screen and (max-width: 767px)", [width(#percent(40.))])])

  let mediumAppScreen = style(.[
    media("only screen and (max-width: 1023px)", [width(#percent(50.))]),
  ])
  ...
  let smallWorkStop = style(.[media("only screen and (max-width: 767px)", [marginBottom(#px(20))])])

  let mediumWorkStop = style(.[
    media("only screen and (max-width: 1023px)", [marginBottom(#px(40))]),
  ])
  ...
  let xsSection = style(.[
    media("only screen and (max-width: 480px)", [padding2(~v=#px(25), ~h=#px(0))]),
  ])

  let smallSection = style(.[padding2(~v=#px(30), ~h=#px(0))])

  let mediumSection = style(.[
    media("only screen and (max-width: 1023px)", [padding2(~v=#px(60), ~h=#px(0))]),
  ])
  ...
  let mediumCityFeature = style(.[
    media("only screen and (max-width: 1023px)", [fontSize(#percent(90.))]),
  ])
  ...
  let mediumIconSmall = style(.[
    media("only screen and (max-width: 1023px)", [width(#px(16)), marginRight(#px(5))]),
  ])
  ...
  let mediumPlanBox = style(.[
    media("only screen and (max-width: 1023px)", [width(#percent(100.)), marginLeft(#px(0))]),
  ])
  ...
  let mediumPlanBoxDiv = style(.[media("only screen and (max-width: 1023px)", [padding(#px(20))])])
  ...
  let smPlanPrice = style(.[
    media("only screen and (max-width: 1023px)", [fontSize(#percent(300.))]),
  ])

  let mediumPlanPrice = style(.[
    media("only screen and (max-width: 1023px)", [fontSize(#percent(250.))]),
  ])
  ...
  let smallPlanPriceMeal = style(.[
    media("only screen and (max-width: 1023px)", [fontSize(#percent(100.))]),
  ])
  ...
  let xsContactForm = style(.[
    media("only screen and (max-width: 1023px)", [width(#percent(100.))]),
  ])
