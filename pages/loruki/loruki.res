module Styles = {
  ...
  let h1 = twStyle([leading(#tight), my(#v2_5)])
  ...
  let navContainer = twStyle([
    h(#v18),
    textColor(#trueGray100),
    flex,
    justifyBetween,
    itemsCenter,
    px(#v10),
  ...
  let aHover = twStyle([hover(tw([borderB(#v2), borderColor(#trueGray100)]))])
}
...
let default = () => {
  <Layout__Loruki>
    ...
    <section className={Tailwind.merge(.[])}>
      // Styles.showcase
      <div>
