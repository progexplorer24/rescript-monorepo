...
let default = () =>
  <div>
    ...
    <main>
      ...
      <section
        className="bg-cover px-4 sm:px-8 pt-8 pb-4 md:py-16  text-white"
      ...
      <section
        className="w-full h-64 bg-red-800 sm:bg-pink-700 md:bg-purple-700 lg:bg-gray-700 xl:bg-green-600"
      />
    </main>
  </div>
